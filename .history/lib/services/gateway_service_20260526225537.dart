...
// ══════════════════════════════════════════════════════════════════════════
//  SMS — envío nativo (sin telephony)
//  Requiere el handler en MainActivity.kt que ya tienes
// ══════════════════════════════════════════════════════════════════════════
...
Future<void> _readInboxAndUpload(ServiceInstance service) async {
  try {
    ...
    for (final item in result) {
      ...
      service
          .invoke('sms_received', {'from': from, 'body': body, 'time': date});
    }
  } catch (e) {
...
void onStart(ServiceInstance service) async {
  // FIX CLAVE: inicializar el binding en el isolate del background service
  // Sin esto, los MethodChannels no tienen a quién enviar mensajes
